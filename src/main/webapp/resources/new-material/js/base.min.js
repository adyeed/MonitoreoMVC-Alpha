if ( window.Modernizr = function ( a , b , c ) {
		...
		l = e ( B , "undefined" ) || e ( B.call , "undefined" ) ? function ( a , b ) {return b in a && e ( a.constructor.prototype[ b ] , "undefined" )} : function ( a , b ) {return B.call ( a , b )}, Function.prototype.bind || (Function.prototype.bind = function ( a ) {
			var b = this;
			...
			return d
		}), x.flexbox = function () {return i ( "flexWrap" )}, x.touch = function () {
			var c;
			return "ontouchstart"in a || a.DocumentTouch && b instanceof DocumentTouch ? c = ! 0 : A ( [ "@media (" , t.join ( "touch-enabled),(" ) , q , ")" , "{#modernizr{top:9px;position:absolute}}" ].join ( "" ) , function ( a ) {c = 9 === a.offsetTop} ), c
		}, x.backgroundsize = function () {return i ( "backgroundSize" )}, x.boxshadow = function () {return i ( "boxShadow" )}, x.csstransforms = function () {return ! ! i ( "transform" )};
		...
		return n.addTest = function ( a , b ) {
			...
			return n
		}, d ( "" ), r = j = null, n._version = m, n._prefixes = t, n._domPrefixes = w, n._cssomPrefixes = v, n.testProp = function ( a ) {return g ( [ a ] )}, n.testAllProps = i, n.testStyles = A, p.className = p.className.replace ( /(^|\s)no-js(\s|$)/ , "$1$2" ) + (o ? " js " + y.join ( " " ) : ""), n
...
+ function ( a ) {
	...
	function b ( b ) {
		return this.each ( function () {
			var d = a ( this ) , e = d.data ( "bs.datepicker" ) , f = a.extend ( {} , c.DEFAULTS , d.data () , "object" == typeof b && b );
			e || d.data ( "bs.datepicker" , e = new c ( this , f ) ), e.show ()
		} )
	}
	...
	c.DEFAULTS = {
		...
		var c = this.$element.pickadate ( "picker" ) , d = c.$root;
		c.on ( {
			close  : function () {a ( document.activeElement ).blur ()} ,
			open   : function () {null === c.get ( "select" ) ? c.set ( "select" , c.get ( "highlight" ) ) : a ( ".picker__date-display" , d ).length || b.display ( c , d )} ,
			render : function () {b.display ( c , d )}
		} )
	};
	var d = a.fn.datepicker;
	a.fn.datepicker = b, a.fn.datepicker.Constructor = c, a.fn.datepicker.noConflict = function () {return a.fn.datepicker = d, this}
} ( jQuery ), function ( a ) {
	"use strict";
	a.fn.floatingLabel = function ( a ) {
		var b = this.closest ( ".form-group-label" );
		if ( b.length )switch ( a ) {
			case"focusin":
				b.addClass ( "control-focus" );
				break;
			case"focusout":
				b.removeClass ( "control-focus" );
				break;
			default:
				this.val () ? b.addClass ( "control-highlight" ) : b.removeClass ( "control-highlight" )
		}
		return this
	}
} ( jQuery ), $ ( function () {
	...
	var d = "textareaAutoSize" , e = "plugin_" + d , f = function ( a ) {return a.replace ( /\s/g , "" ).length > 0};
	c.prototype = {
		init : function () {
	...
	}, a.fn[ d ] = function ( b ) {return this.each ( function () {a.data ( this , e ) || a.data ( this , e , new c ( this , b ) )} ), this}
	...
	c.DEFAULTS = a.extend ( {} , a.fn.modal.Constructor.DEFAULTS , {} ), c.TRANSITION_DURATION = 300, c.TRANSITION_DURATION_BACKDROP = 150, c.prototype = a.extend ( {} , a.fn.modal.Constructor.prototype ), c.prototype.backdrop = function ( b ) {
		...
		if ( this.isShown && this.options.backdrop ) {
			...
			if ( this.$backdrop = a ( document.createElement ( "div" ) ).addClass ( "menu-backdrop" ).appendTo ( this.$body ), this.$element.on ( "click.dismiss.bs.menu" , a.proxy ( function ( a ) {return this.ignoreBackdropClick ? void(this.ignoreBackdropClick = ! 1) : void(a.target === a.currentTarget && ("static" == this.options.backdrop ? this.$element[ 0 ].focus () : this.hide ()))} , this ) ), e && this.$backdrop[ 0 ].offsetWidth, this.$backdrop.addClass ( "in" ), ! b )return;
		...
		var a = this;
		this.$element.hide (), this.backdrop ( function () {a.$element.trigger ( "hidden.bs.menu" )} )
	...
	var d = a.fn.menu;
	a.fn.menu = b, a.fn.menu.Constructor = c, a.fn.menu.noConflict = function () {return a.fn.menu = d, this}, a ( document ).on ( "click.bs.menu.data-api" , '[data-toggle="menu"]' , function ( c ) {
		var d = a ( this ) , e = d.attr ( "href" ) , f = a ( d.attr ( "data-target" ) || e && e.replace ( /.*(?=#[^\s]+$)/ , "" ) ) , g = f.data ( "bs.menu" ) ? "toggle" : a.extend ( { remote : ! /#/.test ( e ) && e } , f.data () , d.data () );
		d.is ( "a" ) && c.preventDefault (), f.one ( "show.bs.menu" , function ( a ) {a.isDefaultPrevented () || (f.attr ( "tabindex" , "-1" ), f.one ( "hidden.bs.menu" , function () {d.is ( ":visible" ) && d.trigger ( "focus" )} ))} ), b.call ( f , g , this )
	} )
} ( jQuery ), function ( a ) {
	"use strict";
	a.fn.tabSwitch = function ( b ) {
		var c = a ( this ) , d = c.closest ( ".tab-nav" ) , e = a ( ".tab-nav-indicator" , d ) , f = c.offset ().left , g = d.offset ().left , h = d.outerWidth ();
		if ( void 0 !== b && void 0 !== b[ 0 ] ) {
			var i = b.offset ().left;
			e.css ( {
				left  : i - g ,
				right : g + h - i - b.outerWidth ()
			} ), b.offset ().left > f && (e.addClass ( "reverse" ), e.one ( "webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend" , function () {e.removeClass ( "reverse" )} ))
		}
		return e.addClass ( "animate" ).css ( {
			left  : f - g ,
			right : g + h - f - c.outerWidth ()
		} ).one ( "webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend" , function () {e.removeClass ( "animate" )} ), this
	}
} ( jQuery ), $ ( function () {
	"use strict";
	...
	var e = a.fn.tile;
	a.fn.tile = c, a.fn.tile.Constructor = d, a.fn.tile.noConflict = function () {return a.fn.tile = e, this}, a ( document ).on ( "click.bs.tile.data-api" , '[data-toggle="tile"]' , function ( d ) {
		var e = a ( this );
	...
	function b ( b ) {
		return this.each ( function () {
			var d = a ( document.body ) , e = d.data ( "bs.toast" ) , f = a.extend ( {} , c.DEFAULTS , b );
			e && a ( ".toast-inner.in" ).length ? (e.hide (), a.support.transition ? a ( document ).one ( "bsTransitionEnd" , ".toast-inner" , function () {d.data ( "bs.toast" , e = new c ( f ) ), e.show ()} ) : (d.data ( "bs.toast" , e = new c ( f ) ), e.show ())) : (d.data ( "bs.toast" , e = new c ( f ) ), e.show ())
		} )
	}
	
	var c = function ( b ) {this.options = b, this.$element = a ( '<div class="toast-inner">' + this.options.content + "</div>" )};
	c.DEFAULTS = {
		alive   : 6e3 ,
		content : "&nbsp;" ,
		hide    : function () {} ,
		show    : function () {}
	}, c.prototype.fbtn = function ( b ) {a ( window ).width () < 768 && a ( ".fbtn-container" ).length && a ( ".fbtn-container" ).css ( "margin-bottom" , b )}, c.prototype.hide = function () {
		var b = this;
		this.$element.removeClass ( "in" ), clearTimeout ( this.$element.data ( "timer" ) ), a.support.transition ? this.$element.one ( "bsTransitionEnd" , function () {b.options.hide ( b.options ), b.$element.remove ()} ) : (b.options.hide ( b.options ), b.$element.remove ()), this.fbtn ( "" )
	...
	var d = a.fn.toast;
	a.fn.toast = b, a.fn.toast.Constructor = c, a.fn.toast.noConflict = function () {return a.fn.toast = d, this}
} ( jQuery ), window.addEventListener && (! function ( a , b ) {
	"use strict";
...
} ), Waves.attach ( ".waves-attach" ), Waves.init ( { duration : 900 } )), WebFontConfig = {
	classes  : ! 1 ,
	google   : { families : [ "Roboto:300,300italic,400,400italic,500,500italic" ] } ,
	active   : function () {$ ( ".avoid-fout" ).each ( function ( a ) {$ ( this ).addClass ( "avoid-fout-done" )} )} ,
	inactive : function () {$ ( ".avoid-fout" ).each ( function ( a ) {$ ( this ).addClass ( "avoid-fout-done" )} )}
}, function () {
